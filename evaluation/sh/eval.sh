...
MODEL_NAME_OR_PATH="/data/ziheng_cheng/checkpoints/msra-sft/H200_numina_qwen2.5-1.5b/global_step_9370/full_model"  # e.g., checkpoints/your-model-name
OUTPUT_DIR="/data/ziheng_cheng/checkpoints/msra-sft/H200_numina_qwen2.5-1.5b/global_step_9370/eval_results"          # e.g., outputs/eval_results
